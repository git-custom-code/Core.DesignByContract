namespace CustomCode.Core.DesignByContract
{
    ...
    /// <summary>
    /// Preconditions for <see cref="ulong"/> types.
    /// </summary>
    /// <remarks>
    ...
    public partial class Requires
    {
        ...
        /// </summary>
        /// <param name="value"> The <see cref="ulong"/> value to be checked. </param>
        ...
        public static void ToBe(ulong value, Func<ulong, bool> condition,
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBe<E>(ulong value, Func<ulong, bool> condition, Func<E> exceptionFactory)
            where E : Exception
        {
            if (new Lazy<bool>(() => condition(value)).Value == false) // invoking the delegate directly will prevent inlining
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBe<E>(ulong value, Func<ulong, bool> condition, Func<ulong, E> exceptionFactory)
            where E : Exception
        {
            if (new Lazy<bool>(() => condition(value)).Value == false) // invoking the delegate directly will prevent inlining
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeBetween(ulong value, ulong minimum, ulong maximum,
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeBetween<E>(ulong value, ulong minimum, ulong maximum, Func<E> exceptionFactory)
            where E : Exception
        {
            if (value < minimum || value > maximum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeBetween<E>(ulong value, ulong minimum, ulong maximum, Func<ulong, ulong, ulong, E> exceptionFactory)
            where E : Exception
        {
            if (value < minimum || value > maximum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeGreaterThan(ulong value, ulong minimum,
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeGreaterThan<E>(ulong value, ulong minimum, Func<E> exceptionFactory)
            where E : Exception
        {
            if (value <= minimum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeGreaterThan<E>(ulong value, ulong minimum, Func<ulong, ulong, E> exceptionFactory)
            where E : Exception
        {
            if (value <= minimum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeGreaterThanOrEqualTo(ulong value, ulong minimum,
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeGreaterThanOrEqualTo<E>(ulong value, ulong minimum, Func<E> exceptionFactory)
            where E : Exception
        {
            if (value < minimum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeGreaterThanOrEqualTo<E>(ulong value, ulong minimum, Func<ulong, ulong, E> exceptionFactory)
            where E : Exception
        {
            if (value < minimum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeLessThan(ulong value, ulong maximum,
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeLessThan<E>(ulong value, ulong maximum, Func<E> exceptionFactory)
            where E : Exception
        {
            if (value >= maximum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeLessThan<E>(ulong value, ulong maximum, Func<ulong, ulong, E> exceptionFactory)
            where E : Exception
        {
            if (value >= maximum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeLessThanOrEqualTo(ulong value, ulong maximum,
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeLessThanOrEqualTo<E>(ulong value, ulong maximum, Func<E> exceptionFactory)
            where E : Exception
        {
            if (value > maximum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeLessThanOrEqualTo<E>(ulong value, ulong maximum, Func<ulong, ulong, E> exceptionFactory)
            where E : Exception
        {
            if (value > maximum)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeOneOf(ulong value, IEnumerable<ulong> expectedValues,
            string parameterName = "Value", string errorMessage = "Value is invalid")
        {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeOneOf<E>(ulong value, IEnumerable<ulong> expectedValues, Func<E> exceptionFactory)
            where E : Exception
        {
            if (expectedValues.Any(v => v == value) == false)
            {
        ...
        [Conditional("contracts_throw")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ToBeOneOf<E>(ulong value, IEnumerable<ulong> expectedValues, Func<ulong, IEnumerable<ulong>, E> exceptionFactory)
            where E : Exception
        {
            if (expectedValues.Any(v => v == value) == false)
            {
