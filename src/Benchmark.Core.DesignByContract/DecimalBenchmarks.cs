...
namespace CustomCode.Core.DesignByContract.Benchmarks
{
    ...
    public partial class DecimalBenchmarks
    {
        ...
        public void RequiresToBe()
        {
            ...
            try
            {
                Requires.ToBe(@decimal, (i) => i > 42m, () => new Exception("Custom exception"));
            }
            catch (Exception)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBe(@decimal, (i) => i > 42m, (i) => new Exception($"Parameterized exception: {i}"));
            }
            catch (Exception)
            {
                // do nothing
        ...
        public void RequiresToBeBetween()
        {
            ...
            try
            {
                Requires.ToBeBetween(@decimal, 1m, 42m);
            }
            catch (ArgumentException)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeBetween(@decimal, 1m, 42m, () => new Exception("Custom exception"));
            }
            catch (Exception)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeBetween(@decimal, 1m, 42m, (i, min, max) => new Exception($"Parameterized exception: {i}, {min}, {max}"));
            }
            catch (Exception)
            {
                // do nothing
        ...
        public void RequiresToBeGreaterThan()
        {
            ...
            try
            {
                Requires.ToBeGreaterThan(@decimal, 42m);
            }
            catch (ArgumentException)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeGreaterThan(@decimal, 42m, () => new Exception("Custom exception"));
            }
            catch (Exception)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeGreaterThan(@decimal, 42m, (i, min) => new Exception($"Parameterized exception: {i}, {min}"));
            }
            catch (Exception)
            {
                // do nothing
        ...
        public void RequiresToBeGreaterThanOrEqualTo()
        {
            ...
            try
            {
                Requires.ToBeGreaterThanOrEqualTo(@decimal, 42m);
            }
            catch (ArgumentException)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeGreaterThanOrEqualTo(@decimal, 42m, () => new Exception("Custom exception"));
            }
            catch (Exception)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeGreaterThanOrEqualTo(@decimal, 42m, (i, min) => new Exception($"Parameterized exception: {i}, {min}"));
            }
            catch (Exception)
            {
                // do nothing
        ...
        public void RequiresToBeLessThan()
        {
            ...
            try
            {
                Requires.ToBeLessThan(@decimal, 1m);
            }
            catch (ArgumentException)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeLessThan(@decimal, 1m, () => new Exception("Custom exception"));
            }
            catch (Exception)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeLessThan(@decimal, 1m, (i, max) => new Exception($"Parameterized exception: {i}, {max}"));
            }
            catch (Exception)
            {
                // do nothing
        ...
        public void RequiresToBeLessThanOrEqualTo()
        {
            ...
            try
            {
                Requires.ToBeLessThanOrEqualTo(@decimal, 1m);
            }
            catch (ArgumentException)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeLessThanOrEqualTo(@decimal, 1m, () => new Exception("Custom exception"));
            }
            catch (Exception)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeLessThanOrEqualTo(@decimal, 1m, (i, max) => new Exception($"Parameterized exception: {i}, {max}"));
            }
            catch (Exception)
            {
                // do nothing
        ...
        public void RequiresToBeOneOf()
        {
            ...
            try
            {
                Requires.ToBeOneOf(@decimal, new[] { 1m, 2m, 3m });
            }
            catch (ArgumentException)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeOneOf(@decimal, new[] { 1m, 2m, 3m }, () => new Exception("Custom exception"));
            }
            catch (Exception)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeOneOf(@decimal, new[] { 1m, 2m, 3m }, (i, ev) => new Exception($"Parameterized exception: {i}, {ev}"));
            }
            catch (Exception)
            {
                // do nothing
