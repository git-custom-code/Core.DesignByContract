...
namespace CustomCode.Core.DesignByContract.Benchmarks
{
    ...
    public partial class NullableShortBenchmarks
    {
        ...
        public void RequiresToBeOneOf()
        {
            ...
            try
            {
                Requires.ToBeOneOf(@short, new short?[] { 1, 2, 3 });
            }
            catch (ArgumentException)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeOneOf(@short, new short?[] { 1, 2, 3 }, () => new Exception("Custom exception"));
            }
            catch (Exception)
            {
                // do nothing
            ...
            try
            {
                Requires.ToBeOneOf(@short, new short?[] { 1, 2, 3 }, (i, ev) => new Exception($"Parameterized exception: {i}, {ev}"));
            }
            catch (Exception)
            {
                // do nothing
